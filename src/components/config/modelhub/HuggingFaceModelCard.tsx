      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-zinc-200 dark:border-neutral-800 pb-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {hfMetadata.is_gated && (
              <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-amber-50 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-500/30 flex items-center gap-1">
          ...
          <p className="text-xs text-zinc-500 dark:text-neutral-400">
            Repository: <span className="font-mono text-zinc-800 dark:text-neutral-300">{hfMetadata.repo_id}</span>
        ...
        <div className="flex items-center gap-2">
          <div className="bg-zinc-50 dark:bg-neutral-950 px-3 py-1.5 rounded-lg border border-zinc-200 dark:border-neutral-800 text-right">
            <span className="text-[10px] text-zinc-500 dark:text-neutral-400 block font-medium">Estimated Size</span>
      ...
      {hfMetadata.available_files && hfMetadata.available_files.length > 1 && (
        <div className="bg-zinc-50 dark:bg-neutral-950/70 border border-zinc-200 dark:border-neutral-800/80 rounded-lg p-3.5 space-y-2">
          ...
          <select
            ...
            className="w-full bg-white dark:bg-neutral-900 border border-zinc-300 dark:border-neutral-700 text-zinc-900 dark:text-neutral-200 text-xs rounded-lg px-3 py-2 outline-none focus:border-amber-500 font-mono"
          >

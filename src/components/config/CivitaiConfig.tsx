          ...
          <div className="bg-zinc-950 border-2 border-cyan-900/60 rounded-xl p-4 shadow-md space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-2">
              ...
              <button
                ...
                className="px-5 py-2.5 text-xs font-bold bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 disabled:opacity-50 text-white rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer shrink-0"
              >

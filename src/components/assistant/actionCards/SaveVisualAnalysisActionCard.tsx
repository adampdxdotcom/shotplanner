    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 border-b border-slate-100 dark:border-zinc-800/80 pb-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 dark:text-zinc-400">
              Automatically saved to project registry cache.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1">
          <span className="px-2.5 py-1 rounded-lg bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 text-xs font-semibold flex items-center gap-1.5 border border-emerald-300 dark:border-emerald-800 shadow-2xs">

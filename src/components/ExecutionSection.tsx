...
export const ExecutionSection: React.FC<ExecutionSectionProps> = ({
  ...
  return (
    <div id="execute-section" className="bg-zinc-900/60 border border-zinc-800/80 rounded-xl p-5 shadow-sm space-y-5">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-zinc-800 pb-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-sm font-semibold text-zinc-100">5. Pipeline Execution &amp; Server Dispatch</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        {/* Step A */}
        <div className="bg-zinc-950/50 p-3 rounded-lg border border-zinc-800 space-y-1">
        ...
        <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-800 space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {activeStepTab === "json" && (
                <button
                  ...
                  className="px-2 py-1 text-xs text-zinc-300 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded flex items-center gap-1"
                >
          ...
          {activeStepTab === "steps" && (
            <div className="space-y-2.5">
              {executionResult.steps.map((s, idx) => (
                <div key={idx} className="bg-zinc-900/60 p-3 rounded-lg border border-zinc-800/80 flex items-start gap-3">
          ...
          {activeStepTab === "json" && (
            <div className="space-y-2">
              ...
              <pre className="max-h-72 overflow-auto font-mono text-[11px] text-emerald-300 bg-zinc-900 p-3 rounded-lg border border-zinc-800/80">

            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Passes basic concept + all uploaded asset metadata into {effectiveDefaultProvider === "gemini" ? "Google Gemini" : "local LM Studio"} to generate ComfyUI-tagged prompts (<code className="text-zinc-300">&lt;Picture 1&gt;</code>, <code className="text-zinc-300">&lt;Video 1&gt;</code>).
                </p>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-lg">
              ...
              >
                ...
                <div className="relative mb-3 flex flex-col items-center justify-center">
                  ...
                  <div className="mt-3 px-3 py-1 rounded-full bg-zinc-900/95 border border-amber-500/40 text-amber-300 font-mono text-xs font-bold flex items-center gap-1.5 shadow-md">

...
export const SceneCharacterCard: React.FC<SceneCharacterCardProps> = ({
  ...
  return (
    <div className="cast-entity-card bg-zinc-900/50 border border-zinc-800/80 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-lg">
      ...
      {/* Right Content: Horizontal Scrollable Asset Carousel */}

...
export const ActorPoseKeyingPanel: React.FC<ActorPoseKeyingPanelProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-2xl flex flex-col gap-5 text-zinc-900 dark:text-zinc-200">
      {/* HEADER */}
      <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-3">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-indigo-50 border border-indigo-200 text-indigo-600 dark:bg-indigo-950/80 dark:border-indigo-800 dark:text-indigo-400 flex items-center justify-center shadow-xs">
            <UserPlus className="w-4 h-4" />
          </div>
          <div>
            <h3 className="text-sm font-bold text-zinc-900 dark:text-white flex items-center gap-2">
              Add Actor Pose & Chroma-Key Inspector
              <span className="text-[10px] font-mono font-semibold text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 px-2 py-0.5 rounded">
                Live Studio
              </span>
            </h3>
        ...
        <button
          type="button"
          onClick={onClose}
          className="text-zinc-400 hover:text-zinc-700 dark:text-zinc-500 dark:hover:text-white p-1 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      <div className="bg-slate-50/70 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col gap-4 shadow-2xs">
        <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-2.5">
          <div className="flex items-center gap-2">
            ...
            {isProcessing && (
              <span className="text-[10px] text-amber-600 dark:text-amber-400 font-mono animate-pulse font-semibold">
                Processing pixels...
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs text-zinc-700 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white bg-white hover:bg-zinc-100 dark:bg-zinc-800 dark:hover:bg-zinc-700 border border-zinc-300 dark:border-transparent px-2.5 py-1 rounded flex items-center gap-1 transition-colors cursor-pointer shadow-2xs"
            ...
            <button
              ...
              className="text-xs text-zinc-700 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white bg-white hover:bg-zinc-100 dark:bg-zinc-800 dark:hover:bg-zinc-700 border border-zinc-300 dark:border-transparent px-2 py-1 rounded flex items-center gap-1 transition-colors cursor-pointer shadow-2xs"
        ...
        <KeyingParameterControls
          ...
          setKeyingMode={setKeyingMode}
          edgeDetail={edgeDetail}
          setEdgeDetail={setEdgeDetail}
        />
      </div>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-zinc-200 dark:border-zinc-800">
        <button
          type="button"
          onClick={onClose}
          className="px-4 py-2 bg-white hover:bg-zinc-100 text-zinc-700 hover:text-zinc-900 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:text-zinc-400 dark:hover:text-white rounded-lg text-xs font-semibold transition-colors cursor-pointer border border-zinc-300 dark:border-zinc-800 shadow-2xs"
        >
          Cancel
        </button>
        ...
        <button
          ...
          className="bg-amber-500 hover:bg-amber-400 disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold px-6 py-2.5 rounded-lg text-xs flex items-center gap-2 transition-all shadow-xs cursor-pointer"
        >

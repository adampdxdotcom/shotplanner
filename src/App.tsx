...
const AssetManagerSection = lazyWithRetry(() => import("./components/AssetManagerSection").then(m => ({ default: m.AssetManagerSection })));
const StagingSection = lazyWithRetry(() => import("./components/StagingSection").then(m => ({ default: m.StagingSection })));
const LLMSection = lazyWithRetry(() => import("./components/LLMSection").then(m => ({ default: m.LLMSection })));
const WorkflowSection = lazyWithRetry(() => import("./components/WorkflowSection").then(m => ({ default: m.WorkflowSection })));
const ExecutionSection = lazyWithRetry(() => import("./components/ExecutionSection").then(m => ({ default: m.ExecutionSection })));
const GallerySection = lazyWithRetry(() => import("./components/GallerySection").then(m => ({ default: m.GallerySection })));
const CastSection = lazyWithRetry(() => import("./components/CastSection").then(m => ({ default: m.CastSection })));
const ConfigSection = lazyWithRetry(() => import("./components/ConfigSection").then(m => ({ default: m.ConfigSection })));
const AppModals = lazyWithRetry(() => import("./components/AppModals").then(m => ({ default: m.AppModals })));
const AssistantFloatingChat = lazyWithRetry(() => import("./components/assistant/AssistantFloatingChat").then(m => ({ default: m.AssistantFloatingChat })));

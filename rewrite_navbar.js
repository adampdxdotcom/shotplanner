...
const oldRightSide = `      <div className="flex items-center gap-2">
        <button
...
const newRightSide = `      <div className="flex flex-col items-end gap-2">
...
// Need to change the outer header from items-center to items-start since the right side is now a column that might grow
content = content.replace(
